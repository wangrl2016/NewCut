...
namespace media {
    ...
    TYPED_TEST_P(SampleTypeTraitsTest, ConvertExmpaleValues) {
        ...
        auto source_two = static_cast<SourceType>(2);
        ...
        auto target_two = static_cast<TargetType>(2);

        SCOPED_TRACE(Config::config_name());

        {
            SCOPED_TRACE("Convert zero_point value");
        ...
        {
            SCOPED_TRACE("Convert value half way between zero point an max");
            auto source_value =
            ...
            if (std::numeric_limits<SourceType>::is_integer &&
                ...
                // middle between two integers, so we expect it to be offset by 0.5.
    ...
    REGISTER_TYPED_TEST_SUITE_P(SampleTypeTraitsTest, ConvertExmpaleValues);
    ...
    typedef ::testing::Types<UnsignedInt8ToFloat32TestConfig,
            ...
            Float64ToSignedInt32TestConfig> TestConfigs;
